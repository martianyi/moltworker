...
export interface MoltbotEnv {
  ...
  /** GitHub token passed through to the OpenClaw container for GitHub integrations */
  GITHUB_TOKEN?: string;
  ...
  /** Comma-separated Telegram user IDs for DM allowlist (enables dmPolicy allowlist) */
